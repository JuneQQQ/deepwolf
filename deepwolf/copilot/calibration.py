...
deepwolf is, as far as the surveyed literature goes, the only werewolf project
with an explainable probabilistic copilot — so it is the only one that can
report *its own advisor's* calibration to the human who relies on it.
"""
...
from deepwolf.copilot.advisor import advise
...
from deepwolf.game.state import GameConfig, build_view
