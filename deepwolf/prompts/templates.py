...
trailer, which lets the offline :class:`~deepwolf.llm.mock.MockProvider` answer
without a real model. That trailer and the JSON reply keys stay in English in
every language — only the human-readable prose is localised.
"""
